...
const AchievementSection = () => {
  const achievements = [
    { awardDetails: "Invitation to San Francisco Summit($1000 stipend for 3 days)", time: "2024-01-05", awardedBy: "Hackclub California", details: <a href="https://firebasestorage.googleapis.com/v0/b/codeday-32a37.appspot.com/o/San%20F.pdf?alt=media&token=7f437ac0-ba35-47a6-9c9b-a6b9d86773f0" className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-black mt-3">view</a> },
